...
const Color blue = Color(0xff01A1FF);
const Color orange = Color(0xffF2BC28);
const Color yellow = Color(0xffFCEB8A);

const Color background = Color(0xff103E7A);
const Color white = Color(0xffffffff);

const Color gray = Color.fromARGB(255, 224, 223, 223);

const String font = 'Droid Arabic Kufi';
